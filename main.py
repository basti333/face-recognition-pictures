...
def prepare_training_data(data_folder_path):
    ...
    for dir_name in dirs:
        ...
        for image_name in subject_images_names:
            ...
            cv2.imshow("Training on image...", cv2.resize(image, (300,300)))
            cv2.waitKey(100)
...
cv2.imshow(subjects[4], cv2.resize(predicted_img4, (300, 300)))
cv2.imshow(subjects[5], cv2.resize(predicted_img5, (300, 300)))
cv2.waitKey(0)
cv2.destroyAllWindows()
cv2.waitKey(1)
cv2.destroyAllWindows()
